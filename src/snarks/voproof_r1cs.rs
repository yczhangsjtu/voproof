...
[{}]",
    ...
    fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
        ...
        let u_vec_1=sparse_mvp(
          ...
          x_vec,
          w_vec)).unwrap();
        let u_vec_1=vector_concat!(
          u_vec_1,
          vec![E::Fr::one()],
          x_vec,
          w_vec);
        let u_vec_1=zero_pad_and_concat!(
          u_vec_1,
          K + S_a + S_b + S_c,
          delta_vec);
        ...
        let nu=hash_to_field::<E::Fr>(
          ...
          cm_u_vec_1,
          cm_s_vec).unwrap());
        let mut rnu_vec=expression_vector!(
          i,
          (nu) - (power_vector_index!(
          gamma,
          K,
          i)),
          K);
        ...
        let h_vec=rnu_vec.iter().map(
          ...
          pk.w_vec.iter().map(
          |a| *a)).map(
          |(u, w)| ((mu - u) * (nu - w)).inverse().unwrap())).collect::<Vec<E::Fr>>();
        let h_vec=zero_pad_and_concat!(
          h_vec,
          K + S_a + S_b + S_c,
          delta_vec_2);
        ...
        define_vec!(
          ...
          vector_index!(
          u_vec_1,
          (i as i64)-(-3*H + S_a + S_b + S_c + 1) as i64+1)))*(linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
          ...
          vector_index!(
          h_vec,
          (i as i64)-(S_a + S_b + S_c + 1) as i64+1)))*(linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
        ...
        check_vector_eq!(
          ...
          1,
          H,
          i-(-H + K + S_a + S_b + S_c + 1)+1))) * (linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
          ...
          vector_index!(
          u_vec_1,
          (i as i64)-(-H + K + S_a + S_b + S_c + 1) as i64+1))) * (linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
        ...
        define_vec!(
          ...
          gamma,
          3*H,
          K + S_a + S_b + S_c + i-(1)+1)))*(vector_index!(
          s_vec,
          K + S_a + S_b + S_c + i)),
          (linear_combination!(
          E::Fr::zero(),
          ...
          1,
          3*H,
          K + S_a + S_b + S_c + i-(1)+1)))*(range_index!(
          1,
          3*H,
          K + S_a + S_b + S_c + i)),
          (linear_combination!(
          ...
          vector_index!(
          h_vec,
          (K + S_a + S_b + S_c + i as i64)-(1) as i64+1)))*(linear_combination!(
          linear_combination!(
          E::Fr::zero(),
          mu*nu,
          range_index!(
          ...
          1,
          S_a + S_b + S_c,
          K + S_a + S_b + S_c + i-(K + 1)+1)))*(linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          range_index!(
          ...
          vector_index!(
          u_vec_1,
          (K + S_a + S_b + S_c + i as i64)-(-H + K + S_a + S_b + S_c + 1) as i64+1)))*(linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
          u_vec_1,
          (K + S_a + S_b + S_c + i as i64)-(-2*H + K + S_a + S_b + S_c + 1) as i64+1))),
          (linear_combination!(
          E::Fr::zero(),
          -power(alpha, 3),
          range_index!(
          1,
          H,
          K + S_a + S_b + S_c + i-(-H + K + S_a + S_b + S_c + 1)+1)))*(linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
          u_vec_1,
          (K + S_a + S_b + S_c + i as i64)-(-3*H + K + S_a + S_b + S_c + 1) as i64+1))),
          (linear_combination!(
          E::Fr::zero(),
          power(alpha, 4),
          range_index!(
          1,
          ell + 1,
          K + S_a + S_b + S_c + i-(3*H + 1)+1)))*(linear_combination!(
          linear_combination!(
          multi_delta!(
          K + S_a + S_b + S_c + i,
          -to_field::<E::Fr>(
          ...
          vector_index!(
          u_vec_1,
          (K + S_a + S_b + S_c + i as i64)-(-3*H + S_a + S_b + S_c + 1) as i64+1)))*(linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
          s_vec,
          (K + S_a + S_b + S_c + i as i64)-(-3*H + S_a + S_b + S_c + 1) as i64+1))),
          (linear_combination!(
          E::Fr::zero(),
          -power(alpha, 5)*beta,
          vector_index!(
          h_vec,
          (K + S_a + S_b + S_c + i as i64)-(S_a + S_b + S_c + 1) as i64+1)))*(linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
          ...
          vector_index!(
          r_vec_tilde,
          (K + S_a + S_b + S_c + i as i64)-(2) as i64+1)))*(range_index!(
          1,
          K + S_a + S_b + S_c,
          K + S_a + S_b + S_c + i))),
          S_a + S_b + S_c + 2));
        ...
        let omega=hash_to_field::<E::Fr>(
          ...
          cm_r_vec_tilde,
          cm_t_vec_1).unwrap());
        let mut sum_vec=vec![E::Fr::zero(); (K + S_a + S_b + S_c) as usize];
        ...
        add_expression_vector_to_vector!(
          ...
          1,
          S_a + S_b + S_c + 1,
          i-(K + S_a + S_b + S_c + 1)+1)))) * (linear_combination!(
          E::Fr::zero(),
          to_field::<E::Fr>(
          1),
          vector_index!(
          t_vec_1,
          (i as i64)-(K + S_a + S_b + S_c) as i64+1))));
        check_vector_eq!(
          sum_vec,
          vec![E::Fr::zero(); (K + S_a + S_b + S_c) as usize],
        ...
        let h_vec_2=expression_vector!(
          ...
          omega.inverse().unwrap(),
          ell + 1,
          -K - 2*S_a - 2*S_b - 2*S_c + i - 1-(1 - ell)+1)),
          -power(alpha, 2)*mu,
          vector_index!(
          v_vec_1,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(K - shiftlength + 1) as i64+1),
          -power(alpha, 2)*nu,
          vector_index!(
          v_vec_3,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(K - shiftlength_2 + 1) as i64+1),
          power(alpha, 2),
          vector_index!(
          v_vec_4,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(K - shiftlength_3 + 1) as i64+1),
          power(alpha, 3)*power(omega, -H + K + S_a + S_b + S_c),
          vector_index!(
          v_vec_5,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(-H - shiftlength_4 + 1) as i64+1),
          power(alpha, 5)*power(omega, -3*H + S_a + S_b + S_c),
          vector_index!(
          v_vec_6,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(1 - shiftlength_5) as i64+1),
          -power(alpha, 5)*beta*power(omega, S_a + S_b + S_c),
          vector_index!(
          v_vec_7,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(-3*H - shiftlength_6 + 1) as i64+1),
          -power(alpha, 5)*beta,
          vector_index!(
          v_vec_8,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(K - shiftlength_7 + 1) as i64+1),
          power(alpha, 6),
          vector_index!(
          v_vec_9,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(K + S_a + S_b + S_c - shiftlength_8) as i64+1),
          mu*power(omega, 3*H - 1),
          vector_index!(
          v_vec_10,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(2 - 3*H) as i64+1),
          ...
          vector_index!(
          v_vec_12,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(2 - K) as i64+1),
          ...
          vector_index!(
          v_vec_14,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(K - shiftlength_1 + 1) as i64+1),
          ...
          vector_index!(
          v_vec_16,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(-3*H - ell + 1) as i64+1),
          -power(alpha, 4)*power(omega, 3*H + ell),
          vector_index!(
          v_vec_17,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(2 - ell) as i64+1),
          -power(alpha, 5),
          vector_index!(
          v_vec_18,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(1 - shiftlength_8) as i64+1),
          power(alpha, 5)*omega,
          vector_index!(
          v_vec_18,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(-shiftlength_8) as i64+1),
          -power(omega, K + 2*S_a + 2*S_b + 2*S_c),
          vector_index!(
          v_vec_19,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(-S_a - S_b - S_c) as i64+1),
          -to_field::<E::Fr>(
          1),
          vector_index!(
          v_vec_20,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(1) as i64+1),
          -alpha,
          vector_index!(
          v_vec_21,
          (-K - 2*S_a - 2*S_b - 2*S_c + i - 1 as i64)-(1) as i64+1),
        ...
        let h_vec_3=expression_vector!(
          ...
          vector_index!(
          v_vec_9,
          (i as i64)-(K + S_a + S_b + S_c - shiftlength_8) as i64+1),
          mu*power(omega, 3*H - 1),
          vector_index!(
          v_vec_10,
        ...
        let c=sum!(
          ...
          power(alpha, 5)*y_1*power(z, -3*H + S_a + S_b + S_c)*power(omega/z, -3*H + S_a + S_b + S_c),
          -power(alpha, 5)*beta*y*power(z, -3*H + S_a + S_b + S_c)*power(omega/z, S_a + S_b + S_c));
        let c_1=sum!(
          ...
          power(alpha, 2)*mu*nu*y*power(z, K)*(E::Fr::one() - power(z, S_a + S_b + S_c))/(E::Fr::one() - z),
          -power(alpha, 2)*power(z, K + 1)*power(omega/z, K)*(E::Fr::one() - power(z, S_a + S_b + S_c))*(E::Fr::one() - power(omega/z, S_a + S_b + S_c))/((E::Fr::one() - z)*(E::Fr::one()*z - omega)),
          ...
          power(alpha, 5)*y_2*(E::Fr::one() - power(z, K + S_a + S_b + S_c))*(omega - z)/(z*(E::Fr::one() - z)),
        ...
        let c_6=sum!(
          power(alpha, 3)*y_1*power(z, -2*H + K + S_a + S_b + S_c)*power(omega/z, -H + K + S_a + S_b + S_c),
          power(alpha, 3)*power(z, -3*H + K + S_a + S_b + S_c + 1)*power(omega/z, -H + K + S_a + S_b + S_c)*(-E::Fr::one() + power(omega/z, H))/(E::Fr::one()*z - omega),
          power(alpha, 4)*z*power(omega/z, 3*H)*(E::Fr::one() - power(omega/z, ell + 1))/(E::Fr::one()*z - omega));
        let c_7=-power(alpha, 5)*beta*y*power(z, K);
        let c_8=power(z, K + S_a + S_b + S_c)*power(omega/z, K + S_a + S_b + S_c)*(-E::Fr::one() + power(omega/z, S_a + S_b + S_c + 1))/(E::Fr::one()*z - omega);
        let c_9=-power(z, D);
        let c_10=-z;
