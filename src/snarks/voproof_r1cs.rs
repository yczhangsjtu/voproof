...
[{}]",
    ...
    fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
        ...
        let u_vec_1 = zero_pad_and_concat!(u_vec_1, K + 3 * S, delta_vec);
        ...
        let s_vec = r_vec
            ...
            .collect::<Vec<E::Fr>>();
        let s_vec = zero_pad_and_concat!(s_vec, K + 3 * S, delta_vec_1);
        ...
        let h_vec = rnu_vec
            ...
            .collect::<Vec<E::Fr>>();
        let h_vec = zero_pad_and_concat!(h_vec, K + 3 * S, delta_vec_2);
            ...
            expression_vector!(
                ...
                power_linear_combination!(
                    ...
                    (linear_combination!(
                        E::Fr::zero(),
                        to_field::<E::Fr>(1),
                        vector_index!(u_vec_1, (i as i64) - (-3 * H + 3 * S + 1) as i64 + 1)
                    )) * (linear_combination!(
                        E::Fr::zero(),
                        to_field::<E::Fr>(1),
                        vector_index!(s_vec, (i as i64) - (-3 * H + 3 * S + 1) as i64 + 1)
                    )),
                    ((linear_combination!(
                        E::Fr::zero(),
                        -to_field::<E::Fr>(1),
                        vector_index!(h_vec, (i as i64) - (3 * S + 1) as i64 + 1)
                    )) * (linear_combination!(
                        E::Fr::zero(),
                        to_field::<E::Fr>(1),
                        vector_index!(s_vec, (i as i64) - (-3 * H + 3 * S + 1) as i64 + 1)
        ...
        check_vector_eq!(
            expression_vector!(
                ...
                (linear_combination!(
                    E::Fr::zero(),
                    -to_field::<E::Fr>(1),
                    range_index!(1, H, i - (-H + K + 3 * S + 1) + 1)
                )) * (linear_combination!(
                    E::Fr::zero(),
                    to_field::<E::Fr>(1),
                    vector_index!(u_vec_1, (i as i64) - (-3 * H + K + 3 * S + 1) as i64 + 1)
                )),
                K + 3 * S
            ),
            expression_vector!(
                ...
                -(linear_combination!(
                    E::Fr::zero(),
                    to_field::<E::Fr>(1),
                    vector_index!(u_vec_1, (i as i64) - (-H + K + 3 * S + 1) as i64 + 1)
                )) * (linear_combination!(
                    E::Fr::zero(),
                    to_field::<E::Fr>(1),
                    vector_index!(u_vec_1, (i as i64) - (-2 * H + K + 3 * S + 1) as i64 + 1)
                )),
                K + 3 * S
            ),
            ...
            expression_vector!(
                ...
                sum!(
                    (linear_combination!(
                        E::Fr::zero(),
                        mu,
                        range_index!(1, 3 * H, K + 3 * S + i - (1) + 1),
                        -to_field::<E::Fr>(1),
                        power_vector_index!(gamma, 3 * H, K + 3 * S + i - (1) + 1)
                    )) * (vector_index!(s_vec, K + 3 * S + i)),
                    (linear_combination!(
                        E::Fr::zero(),
                        -to_field::<E::Fr>(1),
                        range_index!(1, 3 * H, K + 3 * S + i - (1) + 1)
                    )) * (range_index!(1, 3 * H, K + 3 * S + i)),
                    (linear_combination!(
                        E::Fr::zero(),
                        alpha * nu,
                        range_index!(1, K, K + 3 * S + i - (1) + 1),
                        -alpha,
                        power_vector_index!(gamma, K, K + 3 * S + i - (1) + 1)
                    )) * (vector_index!(h_vec, K + 3 * S + i)),
                    (linear_combination!(
                        E::Fr::zero(),
                        -alpha,
                        range_index!(1, K, K + 3 * S + i - (1) + 1)
                    )) * (range_index!(1, K, K + 3 * S + i)),
                    (linear_combination!(
                        E::Fr::zero(),
                        power(alpha, 2),
                        vector_index!(h_vec, (K + 3 * S + i as i64) - (1) as i64 + 1)
                    )) * (linear_combination!(
                        linear_combination!(
                            E::Fr::zero(),
                            mu * nu,
                            range_index!(1, 3 * S, K + 3 * S + i - (K + 1) + 1)
                        ),
                        -mu,
                        vector_index!(pk.w_vec, (K + 3 * S + i as i64) - (K + 1) as i64 + 1),
                        -nu,
                        vector_index!(pk.u_vec, (K + 3 * S + i as i64) - (K + 1) as i64 + 1),
                        to_field::<E::Fr>(1),
                        vector_index!(pk.y_vec, (K + 3 * S + i as i64) - (K + 1) as i64 + 1)
                    )),
                    (linear_combination!(
                        E::Fr::zero(),
                        -power(alpha, 2),
                    ...
                    (linear_combination!(
                        ...
                        vector_index!(
                            u_vec_1,
                            (K + 3 * S + i as i64) - (-H + K + 3 * S + 1) as i64 + 1
                        )
                    )) * (linear_combination!(
                        E::Fr::zero(),
                        to_field::<E::Fr>(1),
                    ...
                    (linear_combination!(
                        E::Fr::zero(),
                        -power(alpha, 3),
                        range_index!(1, H, K + 3 * S + i - (-H + K + 3 * S + 1) + 1)
                    )) * (linear_combination!(
                        E::Fr::zero(),
                        to_field::<E::Fr>(1),
                        vector_index!(
                    ...
                    (linear_combination!(
                        E::Fr::zero(),
                        power(alpha, 4),
                        range_index!(1, ell + 1, K + 3 * S + i - (3 * H + 1) + 1)
                    )) * (linear_combination!(
                        ...
                        to_field::<E::Fr>(1),
                        vector_index!(u_vec_1, (K + 3 * S + i as i64) - (1) as i64 + 1),
                        -to_field::<E::Fr>(1),
                        vector_index!(x_vec, (K + 3 * S + i as i64) - (3 * H + 2) as i64 + 1)
                    )),
                    (linear_combination!(
                        E::Fr::zero(),
                        power(alpha, 5),
                    ...
                    (linear_combination!(
                        E::Fr::zero(),
                        -power(alpha, 5) * beta,
                        vector_index!(h_vec, (K + 3 * S + i as i64) - (3 * S + 1) as i64 + 1)
                    )) * (linear_combination!(
                        E::Fr::zero(),
                        to_field::<E::Fr>(1),
                        vector_index!(
                    ...
                    (linear_combination!(
                        ...
                        E::Fr::zero(),
                        to_field::<E::Fr>(1),
                        vector_index!(pk.v_vec, (K + 3 * S + i as i64) - (K + 1) as i64 + 1)
                    )),
                    (linear_combination!(
                        E::Fr::zero(),
                        -power(alpha, 5),
                        vector_index!(r_vec_tilde, (K + 3 * S + i as i64) - (1) as i64 + 1),
                        power(alpha, 5),
                        vector_index!(r_vec_tilde, (K + 3 * S + i as i64) - (2) as i64 + 1)
                    )) * (range_index!(1, K + 3 * S, K + 3 * S + i))
                ),
                3 * S + 2
            )
        );
        ...
        add_expression_vector_to_vector!(
            ...
            (linear_combination!(linear_combination!(
                E::Fr::zero(),
                -to_field::<E::Fr>(1),
                range_index!(1, 3 * S + 1, i - (K + 3 * S + 1) + 1)
            ))) * (linear_combination!(
                E::Fr::zero(),
                to_field::<E::Fr>(1),
                vector_index!(t_vec_1, (i as i64) - (K + 3 * S) as i64 + 1)
            ))
        );
        check_vector_eq!(
            sum_vec,
        ...
        let v_vec_14 = vector_power_mul!(v_vec_2, to_field::<E::Fr>(1), 3 * S);
        ...
        let v_vec_22 = power_power_mul!(to_field::<E::Fr>(1), 3 * S, to_field::<E::Fr>(1), 3 * S);
        let h_vec_2 = expression_vector!(
            ...
            linear_combination!(
                ...
                vector_index!(v_vec_12, (-K - 6 * S + i - 1 as i64) - (2 - K) as i64 + 1),
                -alpha * power(gamma * omega, K - 1),
                vector_index!(v_vec_13, (-K - 6 * S + i - 1 as i64) - (2 - K) as i64 + 1),
                power(alpha, 2) * mu * nu,
                vector_index!(
                    v_vec_14,
                ...
                -power(alpha, 4) * power(omega, 3 * H + ell),
                vector_index!(v_vec_17, (-K - 6 * S + i - 1 as i64) - (2 - ell) as i64 + 1),
                -power(alpha, 5),
                vector_index!(
                    v_vec_18,
                ...
                -power(omega, K + 6 * S),
                vector_index!(v_vec_19, (-K - 6 * S + i - 1 as i64) - (-3 * S) as i64 + 1),
                -to_field::<E::Fr>(1),
                vector_index!(v_vec_20, (-K - 6 * S + i - 1 as i64) - (1) as i64 + 1),
                -alpha,
                vector_index!(v_vec_21, (-K - 6 * S + i - 1 as i64) - (1) as i64 + 1),
                -power(alpha, 2) * power(omega, K),
                vector_index!(v_vec_22, (-K - 6 * S + i - 1 as i64) - (1) as i64 + 1)
            ),
            K + 6 * S + 1
        );
        let h_vec_3 = expression_vector!(
            ...
            linear_combination!(
                linear_combination!(
                    E::Fr::zero(),
                    -power(alpha, 4) * power(omega, 3 * H + ell),
                    power_vector_index!(omega.inverse().unwrap(), ell + 1, i - (1 - ell) + 1)
                ),
                -power(alpha, 2) * mu,
                vector_index!(v_vec_1, (i as i64) - (K - shiftlength + 1) as i64 + 1),
                -power(alpha, 2) * nu,
                vector_index!(v_vec_3, (i as i64) - (K - shiftlength_2 + 1) as i64 + 1),
                power(alpha, 2),
                vector_index!(v_vec_4, (i as i64) - (K - shiftlength_3 + 1) as i64 + 1),
                power(alpha, 3) * power(omega, -H + K + 3 * S),
                vector_index!(v_vec_5, (i as i64) - (-H - shiftlength_4 + 1) as i64 + 1),
                power(alpha, 5) * power(omega, -3 * H + 3 * S),
                vector_index!(v_vec_6, (i as i64) - (1 - shiftlength_5) as i64 + 1),
                -power(alpha, 5) * beta * power(omega, 3 * S),
                vector_index!(
                    v_vec_7,
                ...
                -power(alpha, 5) * beta,
                vector_index!(v_vec_8, (i as i64) - (K - shiftlength_7 + 1) as i64 + 1),
                power(alpha, 6),
                vector_index!(v_vec_9, (i as i64) - (K + 3 * S - shiftlength_8) as i64 + 1),
                mu * power(omega, 3 * H - 1),
                vector_index!(v_vec_10, (i as i64) - (2 - 3 * H) as i64 + 1),
                -power(gamma * omega, 3 * H - 1),
                vector_index!(v_vec_11, (i as i64) - (2 - 3 * H) as i64 + 1),
                alpha * nu * power(omega, K - 1),
                vector_index!(v_vec_12, (i as i64) - (2 - K) as i64 + 1),
                -alpha * power(gamma * omega, K - 1),
                vector_index!(v_vec_13, (i as i64) - (2 - K) as i64 + 1),
                power(alpha, 2) * mu * nu,
                vector_index!(v_vec_14, (i as i64) - (K - shiftlength_1 + 1) as i64 + 1),
                -power(alpha, 3) * power(omega, K + 3 * S - 1),
                vector_index!(v_vec_15, (i as i64) - (2 - 3 * H) as i64 + 1),
                power(alpha, 4) * power(omega, 3 * H + ell),
                vector_index!(v_vec_16, (i as i64) - (-3 * H - ell + 1) as i64 + 1),
                -power(alpha, 4) * power(omega, 3 * H + ell),
                vector_index!(v_vec_17, (i as i64) - (2 - ell) as i64 + 1),
                -power(alpha, 5),
                vector_index!(v_vec_18, (i as i64) - (1 - shiftlength_8) as i64 + 1),
                power(alpha, 5) * omega,
                vector_index!(v_vec_18, (i as i64) - (-shiftlength_8) as i64 + 1),
                -power(omega, K + 6 * S),
                vector_index!(v_vec_19, (i as i64) - (-3 * S) as i64 + 1),
                -to_field::<E::Fr>(1),
                vector_index!(v_vec_20, (i as i64) - (1) as i64 + 1),
                -alpha,
                vector_index!(v_vec_21, (i as i64) - (1) as i64 + 1),
                -power(alpha, 2) * power(omega, K),
                vector_index!(v_vec_22, (i as i64) - (1) as i64 + 1)
            ),
            K + 6 * S + 1
        );
        ...
        let y_2 =
            eval_vector_expression!(omega / z, i, vector_index!(r_vec_tilde, i), K + 3 * S + 1);
        let c = sum!(
            z * (mu
        ...
        let c_1 = sum!(
            ...
            -alpha * z * (E::Fr::one() - power(z, K)) * (E::Fr::one() - power(omega / z, K))
                / ((E::Fr::one() - z) * (E::Fr::one() * z - omega)),
            power(alpha, 2) * mu * nu * y * power(z, K) * (E::Fr::one() - power(z, 3 * S))
                / (E::Fr::one() - z),
            -power(alpha, 2)
                * power(z, K + 1)
                * power(omega / z, K)
                * (E::Fr::one() - power(z, 3 * S))
                * (E::Fr::one() - power(omega / z, 3 * S))
                / ((E::Fr::one() - z) * (E::Fr::one() * z - omega)),
            (power(alpha, 4)
                * power(z, 3 * H + 2)
                * power(omega / z, 3 * H)
            ...
            power(alpha, 4)
                ...
                * (-E::Fr::one() + power(omega / z, ell + 1))
                / (E::Fr::one() * z - omega),
            power(alpha, 5) * y_2 * (E::Fr::one() - power(z, K + 3 * S)) * (omega - z)
                / (z * (E::Fr::one() - z)),
        ...
        let c_8 = power(z, K + 3 * S)
            * power(omega / z, K + 3 * S)
            * (-E::Fr::one() + power(omega / z, 3 * S + 1))
            / (E::Fr::one() * z - omega);
        let c_9 = -power(z, D);
        let c_10 = -z;
