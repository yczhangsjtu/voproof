...
impl<'a, E: PairingEngine> SNARK<'a, E> for VOProofR1CS {
    type Size = R1CSSize;
    type CS = R1CS<E::Fr>;
    ...
    fn index(pp: &UniversalParams<E>, cs: &R1CS<E::Fr>)
        ...
        let M_mat=(cs.arows.iter().chain(cs.brows.iter().map(|i| i + H)).chain(cs.crows.iter().map(|i| i + H * 2)).collect::<Vec<u64>>(), cs.acols.iter().chain(cs.bcols).chain(cs.ccols).collect::<Vec<u64>>(), cs.avals.iter().chain(cs.bvals).chain(cs.cvals).collect::<Vec<E::Fr>>());
        let u_vec=(1..=3*S).map(|i| power(gamma, M_mat.0[i] as i64)).collect::<Vec<E::Fr>>();
        let w_vec=(1..=3*S).map(|i| power(gamma, M_mat.1[i] as i64)).collect::<Vec<E::Fr>>();
        let v_vec=M_mat.2;
    ...
    fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
        ...
        define_vec!(t_vec, expression_vector!(i, sum!((linear_combination!(E::Fr::zero(), mu, power_vector_index!(1, 3*H, K + 3*S + i-(1)+1), -to_field::<E::Fr>(1), power_vector_index!(gamma, 3*H, K + 3*S + i-(1)+1)))*(vector_index!(s_vec, K + 3*S + i)), (linear_combination!(E::Fr::zero(), -to_field::<E::Fr>(1), power_vector_index!(1, 3*H, K + 3*S + i-(1)+1)))*(power_vector_index!(1, 3*H, K + 3*S + i)), (linear_combination!(E::Fr::zero(), alpha*nu, power_vector_index!(1, K, K + 3*S + i-(1)+1), -alpha, power_vector_index!(gamma, K, K + 3*S + i-(1)+1)))*(vector_index!(h_vec, K + 3*S + i)), (linear_combination!(E::Fr::zero(), -alpha, power_vector_index!(1, K, K + 3*S + i-(1)+1)))*(power_vector_index!(1, K, K + 3*S + i)), (linear_combination!(E::Fr::zero(), alpha**2, vector_index!(h_vec, (K + 3*S + i as i64)-(1) as i64+1)))*(linear_combination!(linear_combination!(E::Fr::zero(), mu*nu, power_vector_index!(1, K, K + 3*S + i-(K + 1)+1)), -mu, vector_index!(pk.w_vec, (K + 3*S + i as i64)-(K + 1) as i64+1), -nu, vector_index!(pk.u_vec, (K + 3*S + i as i64)-(K + 1) as i64+1), to_field::<E::Fr>(1), vector_index!(pk.y_vec, (K + 3*S + i as i64)-(K + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha**2, power_vector_index!(1, K, K + 3*S + i-(1)+1)))*(power_vector_index!(1, K, K + 3*S + i)), (linear_combination!(E::Fr::zero(), alpha**3, vector_index!(u_vec_1, (K + 3*S + i as i64)-(-H + K + 3*S + 1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(u_vec_1, (K + 3*S + i as i64)-(-2*H + K + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha**3, power_vector_index!(1, H, K + 3*S + i-(-H + K + 3*S + 1)+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(u_vec_1, (K + 3*S + i as i64)-(-3*H + K + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), alpha**5, vector_index!(u_vec_1, (K + 3*S + i as i64)-(-3*H + 3*S + 1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(s_vec, (K + 3*S + i as i64)-(-3*H + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha**5*beta, vector_index!(h_vec, (K + 3*S + i as i64)-(3*S + 1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(s_vec, (K + 3*S + i as i64)-(-3*H + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha**5*beta, vector_index!(h_vec, (K + 3*S + i as i64)-(1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(pk.v_vec, (K + 3*S + i as i64)-(K + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha**5, vector_index!(r_vec_tilde, (K + 3*S + i as i64)-(1) as i64+1), alpha**5, vector_index!(r_vec_tilde, (K + 3*S + i as i64)-(2) as i64+1)))*(power_vector_index!(1, K + 3*S, K + 3*S + i))), 3*S + 2));
