...
impl<E: PairingEngine> SNARK<E> for VOProofR1CS {
    ...
    fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
        ...
        define_vec!(t_vec, expression_vector!(i, sum!((linear_combination!(E::Fr::zero(), mu, power_vector_index!(1, 3*H, K + 3*S + i-(1)+1), -to_field::<E::Fr>(1), power_vector_index!(gamma, 3*H, K + 3*S + i-(1)+1)))*(vector_index!(s_vec, K + 3*S + i)), (linear_combination!(E::Fr::zero(), -to_field::<E::Fr>(1), power_vector_index!(1, 3*H, K + 3*S + i-(1)+1)))*(power_vector_index!(1, 3*H, K + 3*S + i)), (linear_combination!(E::Fr::zero(), alpha*nu, power_vector_index!(1, K, K + 3*S + i-(1)+1), -alpha, power_vector_index!(gamma, K, K + 3*S + i-(1)+1)))*(vector_index!(h_vec, K + 3*S + i)), (linear_combination!(E::Fr::zero(), -alpha, power_vector_index!(1, K, K + 3*S + i-(1)+1)))*(power_vector_index!(1, K, K + 3*S + i)), (linear_combination!(E::Fr::zero(), alpha.powi(2), vector_index!(h_vec, (K + 3*S + i as i64)-(1) as i64+1)))*(linear_combination!(linear_combination!(E::Fr::zero(), mu*nu, power_vector_index!(1, K, K + 3*S + i-(K + 1)+1)), -mu, vector_index!(pk.w_vec, (K + 3*S + i as i64)-(K + 1) as i64+1), -nu, vector_index!(pk.u_vec, (K + 3*S + i as i64)-(K + 1) as i64+1), to_field::<E::Fr>(1), vector_index!(pk.y_vec, (K + 3*S + i as i64)-(K + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha.powi(2), power_vector_index!(1, K, K + 3*S + i-(1)+1)))*(power_vector_index!(1, K, K + 3*S + i)), (linear_combination!(E::Fr::zero(), alpha.powi(3), vector_index!(u_vec_1, (K + 3*S + i as i64)-(-H + K + 3*S + 1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(u_vec_1, (K + 3*S + i as i64)-(-2*H + K + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha.powi(3), power_vector_index!(1, H, K + 3*S + i-(-H + K + 3*S + 1)+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(u_vec_1, (K + 3*S + i as i64)-(-3*H + K + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), alpha.powi(5), vector_index!(u_vec_1, (K + 3*S + i as i64)-(-3*H + 3*S + 1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(s_vec, (K + 3*S + i as i64)-(-3*H + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha.powi(5)*beta, vector_index!(h_vec, (K + 3*S + i as i64)-(3*S + 1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(s_vec, (K + 3*S + i as i64)-(-3*H + 3*S + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha.powi(5)*beta, vector_index!(h_vec, (K + 3*S + i as i64)-(1) as i64+1)))*(linear_combination!(E::Fr::zero(), to_field::<E::Fr>(1), vector_index!(pk.v_vec, (K + 3*S + i as i64)-(K + 1) as i64+1))), (linear_combination!(E::Fr::zero(), -alpha.powi(5), vector_index!(r_vec_tilde, (K + 3*S + i as i64)-(1) as i64+1), alpha.powi(5), vector_index!(r_vec_tilde, (K + 3*S + i as i64)-(2) as i64+1)))*(power_vector_index!(1, K + 3*S, K + 3*S + i))), 3*S + 2));
        ...
        let v_vec_10=vector_power_mul!(s_vec, omega.recip(), 3*H);
        let v_vec_11=vector_power_mul!(s_vec, 1/(gamma*omega), 3*H);
        let v_vec_12=vector_power_mul!(h_vec, omega.recip(), K);
        let v_vec_13=vector_power_mul!(h_vec, 1/(gamma*omega), K);
        let v_vec_14=vector_power_mul!(v_vec_2, 1, K);
        let v_vec_15=vector_power_mul!(u_vec_1, omega.recip(), H);
        let v_vec_16=vector_power_mul!(u_vec_1, omega.recip(), ell + 1);
        let v_vec_17=vector_power_mul!(x_vec, omega.recip(), ell + 1);
        let v_vec_18=vector_power_mul!(v_vec_9, 1, K + 3*S);
        let v_vec_19=vector_power_mul!(t_vec_1, omega.recip(), 3*S + 1);
        let v_vec_20=power_power_mul!(1, 3*H, 1, 3*H);
        let v_vec_21=power_power_mul!(1, K, 1, K);
        let v_vec_22=power_power_mul!(1, K, 1, K);
        let h_vec_2=expression_vector!(i, linear_combination!(linear_combination!(E::Fr::zero(), -alpha.powi(4)*omega.powf(3*H + ell), power_vector_index!(omega.recip(), ell + 1, -K - 6*S + i - 1-(1 - ell)+1)), -alpha.powi(2)*mu, vector_index!(v_vec_1, (-K - 6*S + i - 1 as i64)-(K - shiftlength + 1) as i64+1), -alpha.powi(2)*nu, vector_index!(v_vec_3, (-K - 6*S + i - 1 as i64)-(K - shiftlength_2 + 1) as i64+1), alpha.powi(2), vector_index!(v_vec_4, (-K - 6*S + i - 1 as i64)-(K - shiftlength_3 + 1) as i64+1), alpha.powi(3)*omega.powf(-H + K + 3*S), vector_index!(v_vec_5, (-K - 6*S + i - 1 as i64)-(-H - shiftlength_4 + 1) as i64+1), alpha.powi(5)*omega.powf(-3*H + 3*S), vector_index!(v_vec_6, (-K - 6*S + i - 1 as i64)-(1 - shiftlength_5) as i64+1), -alpha.powi(5)*beta*omega.powf(3*S), vector_index!(v_vec_7, (-K - 6*S + i - 1 as i64)-(-3*H - shiftlength_6 + 1) as i64+1), -alpha.powi(5)*beta, vector_index!(v_vec_8, (-K - 6*S + i - 1 as i64)-(K - shiftlength_7 + 1) as i64+1), alpha.powi(6), vector_index!(v_vec_9, (-K - 6*S + i - 1 as i64)-(K + 3*S - shiftlength_8) as i64+1), mu*omega.powf(3*H - 1), vector_index!(v_vec_10, (-K - 6*S + i - 1 as i64)-(2 - 3*H) as i64+1), -(gamma*omega).powf(3*H - 1), vector_index!(v_vec_11, (-K - 6*S + i - 1 as i64)-(2 - 3*H) as i64+1), alpha*nu*omega.powf(K - 1), vector_index!(v_vec_12, (-K - 6*S + i - 1 as i64)-(2 - K) as i64+1), -alpha*(gamma*omega).powf(K - 1), vector_index!(v_vec_13, (-K - 6*S + i - 1 as i64)-(2 - K) as i64+1), alpha.powi(2)*mu*nu, vector_index!(v_vec_14, (-K - 6*S + i - 1 as i64)-(K - shiftlength_1 + 1) as i64+1), -alpha.powi(3)*omega.powf(K + 3*S - 1), vector_index!(v_vec_15, (-K - 6*S + i - 1 as i64)-(2 - 3*H) as i64+1), alpha.powi(4)*omega.powf(3*H + ell), vector_index!(v_vec_16, (-K - 6*S + i - 1 as i64)-(-3*H - ell + 1) as i64+1), -alpha.powi(4)*omega.powf(3*H + ell), vector_index!(v_vec_17, (-K - 6*S + i - 1 as i64)-(2 - ell) as i64+1), -alpha.powi(5), vector_index!(v_vec_18, (-K - 6*S + i - 1 as i64)-(1 - shiftlength_8) as i64+1), alpha.powi(5)*omega, vector_index!(v_vec_18, (-K - 6*S + i - 1 as i64)-(-shiftlength_8) as i64+1), -omega.powf(K + 6*S), vector_index!(v_vec_19, (-K - 6*S + i - 1 as i64)-(-3*S) as i64+1), -to_field::<E::Fr>(1), vector_index!(v_vec_20, (-K - 6*S + i - 1 as i64)-(1) as i64+1), -alpha, vector_index!(v_vec_21, (-K - 6*S + i - 1 as i64)-(1) as i64+1), -alpha.powi(2), vector_index!(v_vec_22, (-K - 6*S + i - 1 as i64)-(1) as i64+1)), K + 6*S + 1);
        let h_vec_3=expression_vector!(i, linear_combination!(linear_combination!(E::Fr::zero(), -alpha.powi(4)*omega.powf(3*H + ell), power_vector_index!(omega.recip(), ell + 1, i-(1 - ell)+1)), -alpha.powi(2)*mu, vector_index!(v_vec_1, (i as i64)-(K - shiftlength + 1) as i64+1), -alpha.powi(2)*nu, vector_index!(v_vec_3, (i as i64)-(K - shiftlength_2 + 1) as i64+1), alpha.powi(2), vector_index!(v_vec_4, (i as i64)-(K - shiftlength_3 + 1) as i64+1), alpha.powi(3)*omega.powf(-H + K + 3*S), vector_index!(v_vec_5, (i as i64)-(-H - shiftlength_4 + 1) as i64+1), alpha.powi(5)*omega.powf(-3*H + 3*S), vector_index!(v_vec_6, (i as i64)-(1 - shiftlength_5) as i64+1), -alpha.powi(5)*beta*omega.powf(3*S), vector_index!(v_vec_7, (i as i64)-(-3*H - shiftlength_6 + 1) as i64+1), -alpha.powi(5)*beta, vector_index!(v_vec_8, (i as i64)-(K - shiftlength_7 + 1) as i64+1), alpha.powi(6), vector_index!(v_vec_9, (i as i64)-(K + 3*S - shiftlength_8) as i64+1), mu*omega.powf(3*H - 1), vector_index!(v_vec_10, (i as i64)-(2 - 3*H) as i64+1), -(gamma*omega).powf(3*H - 1), vector_index!(v_vec_11, (i as i64)-(2 - 3*H) as i64+1), alpha*nu*omega.powf(K - 1), vector_index!(v_vec_12, (i as i64)-(2 - K) as i64+1), -alpha*(gamma*omega).powf(K - 1), vector_index!(v_vec_13, (i as i64)-(2 - K) as i64+1), alpha.powi(2)*mu*nu, vector_index!(v_vec_14, (i as i64)-(K - shiftlength_1 + 1) as i64+1), -alpha.powi(3)*omega.powf(K + 3*S - 1), vector_index!(v_vec_15, (i as i64)-(2 - 3*H) as i64+1), alpha.powi(4)*omega.powf(3*H + ell), vector_index!(v_vec_16, (i as i64)-(-3*H - ell + 1) as i64+1), -alpha.powi(4)*omega.powf(3*H + ell), vector_index!(v_vec_17, (i as i64)-(2 - ell) as i64+1), -alpha.powi(5), vector_index!(v_vec_18, (i as i64)-(1 - shiftlength_8) as i64+1), alpha.powi(5)*omega, vector_index!(v_vec_18, (i as i64)-(-shiftlength_8) as i64+1), -omega.powf(K + 6*S), vector_index!(v_vec_19, (i as i64)-(-3*S) as i64+1), -to_field::<E::Fr>(1), vector_index!(v_vec_20, (i as i64)-(1) as i64+1), -alpha, vector_index!(v_vec_21, (i as i64)-(1) as i64+1), -alpha.powi(2), vector_index!(v_vec_22, (i as i64)-(1) as i64+1)), K + 6*S + 1);
        ...
        let c=sum!(z*(mu*(gamma*omega - z)*((omega/z).powf(3*H) - 1) - (omega - z)*((gamma*omega/z).powf(3*H) - 1))/((omega - z)*(gamma*omega - z)), alpha.powi(5)*y_1*z.powf(-3*H + 3*S)*(omega/z).powf(-3*H + 3*S), -alpha.powi(5)*beta*y*z.powf(-3*H + 3*S)*(omega/z).powf(3*S));
        let c_1=sum!(-z*(z.powf(3*H) - 1)*((omega/z).powf(3*H) - 1)/((omega - z)*(z - 1)), -alpha*z*(z.powf(K) - 1)*((omega/z).powf(K) - 1)/((omega - z)*(z - 1)), alpha.powi(2)*mu*nu*y*z.powf(K)*(z.powf(K) - 1)/(z - 1), -alpha.powi(2)*z*(z.powf(K) - 1)*((omega/z).powf(K) - 1)/((omega - z)*(z - 1)), (alpha.powi(4)*z.powf(3*H + 1)*(omega/z).powf(3*H)*(-omega*(omega/z).powf(ell) + z)/(omega - z)) * (eval_vector_expression!(z, i, x_vec[i], ell)), alpha.powi(4)*z.powf(3*H)*(omega/z).powf(3*H)*(-omega*(omega/z).powf(ell) + z)/(omega - z), alpha.powi(5)*y_2*(omega - z)*(z.powf(K + 3*S) - 1)/(z*(z - 1)), alpha.powi(6)*y_2*z.powf(K + 3*S - 1));
        let c_2=alpha*z*(nu*(gamma*omega - z)*((omega/z).powf(K) - 1) - (omega - z)*((gamma*omega/z).powf(K) - 1))/((omega - z)*(gamma*omega - z));
        let c_3=-alpha.powi(2)*mu*y*z.powf(K);
        let c_4=-alpha.powi(2)*nu*y*z.powf(K);
        let c_5=alpha.powi(2)*y*z.powf(K);
        let c_6=sum!(alpha.powi(3)*y_1*z.powf(-2*H + K + 3*S)*(omega/z).powf(-H + K + 3*S), alpha.powi(3)*z.powf(-3*H + K + 3*S + 1)*(omega/z).powf(-H + K + 3*S)*(1 - (omega/z).powf(H))/(omega - z), alpha.powi(4)*(omega/z).powf(3*H)*(omega*(omega/z).powf(ell) - z)/(omega - z));
        let c_7=-alpha.powi(5)*beta*y*z.powf(K);
        let c_8=z.powf(K + 3*S)*(omega/z).powf(K + 3*S)*(1 - (omega/z).powf(3*S + 1))/(omega - z);
        let c_9=-z.powf(D);
        let c_10=-z;
