...
impl<'a, E: PairingEngine, F: Field> SNARK<E, F> for VOProofR1CS {
    ...
    fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
        ...
        let mu=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1));
        ...
        let nu=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1, cm_s_vec));
        ...
        let beta=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec));
        ...
        let alpha=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde));
        ...
        let omega=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1));
        ...
        let z=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1, cm_h_vec_2, cm_h_vec_3));
        ...
        g_poly[0]+=c_1;
        let cm_g=sum!((cm_s_vec).mul(c), (cm_h_vec).mul(c_2), (cm_w_vec).mul(c_3), (cm_u_vec).mul(c_4), (cm_y_vec).mul(c_5), (cm_u_vec_1).mul(c_6), (cm_v_vec).mul(c_7), (cm_t_vec_1).mul(c_8), (cm_h_vec_2).mul(c_9), (cm_h_vec_3).mul(c_10), scalar_to_commitment(pk.powers, c_10));
        let fs=vec!(h_vec_poly, u_vec_1_poly, r_vec_tilde_poly);
        let gs=vec!(g_poly);
        let zz=z;
        let z=omega/z;
        let rand_xi=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1, cm_h_vec_2, cm_h_vec_3, cm_g, omega/z, y, y_1, y_2, z, 0));
        let rand_xi_2=hash_to_field(to_bytes!(pk.verifier_key.cm_u_vec, pk.verifier_key.cm_w_vec, pk.verifier_key.cm_v_vec, pk.verifier_key.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1, cm_h_vec_2, cm_h_vec_3, cm_g, omega/z, y, y_1, y_2, z, 0));
    ...
    fn verify(vk: &Self::VK, x: &Self::Ins, proof: &Self::Pf) -> Result<(), Error> {
        ...
        let ell=size.input_size;
        let gamma=F::GENERATOR;
        let mu=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1));
        let nu=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1, cm_s_vec));
        let beta=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec));
        let alpha=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde));
        let omega=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1));
        let z=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1, cm_h_vec_2, cm_h_vec_3));
        let c=sum!(z*(mu*(gamma*omega - z)*((omega/z)**(3*H) - 1) - (omega - z)*((gamma*omega/z)**(3*H) - 1))/((omega - z)*(gamma*omega - z)), alpha**5*y_1*z**(-3*H + 3*S)*(omega/z)**(-3*H + 3*S), -alpha**5*beta*y*z**(-3*H + 3*S)*(omega/z)**(3*S));
        let c_1=sum!(-z*(z**(3*H) - 1)*((omega/z)**(3*H) - 1)/((omega - z)*(z - 1)), -alpha*z*(z**K - 1)*((omega/z)**K - 1)/((omega - z)*(z - 1)), alpha**2*mu*nu*y*z**K*(z**K - 1)/(z - 1), -alpha**2*z*(z**K - 1)*((omega/z)**K - 1)/((omega - z)*(z - 1)), (alpha**4*z**(3*H + 1)*(omega/z)**(3*H)*(-omega*(omega/z)**ell + z)/(omega - z)) * (eval_vector_expression!(z, i, x_vec[i], ell)), alpha**4*z**(3*H)*(omega/z)**(3*H)*(-omega*(omega/z)**ell + z)/(omega - z), alpha**5*y_2*(omega - z)*(z**(K + 3*S) - 1)/(z*(z - 1)), alpha**6*y_2*z**(K + 3*S - 1));
        let c_2=alpha*z*(nu*(gamma*omega - z)*((omega/z)**K - 1) - (omega - z)*((gamma*omega/z)**K - 1))/((omega - z)*(gamma*omega - z));
        let c_3=-alpha**2*mu*y*z**K;
        ...
        let c_10=-z;
        let cm_g=sum!((cm_s_vec).mul(c), (cm_h_vec).mul(c_2), (cm_w_vec).mul(c_3), (cm_u_vec).mul(c_4), (cm_y_vec).mul(c_5), (cm_u_vec_1).mul(c_6), (cm_v_vec).mul(c_7), (cm_t_vec_1).mul(c_8), (cm_h_vec_2).mul(c_9), (cm_h_vec_3).mul(c_10), scalar_to_commitment(pk.powers, c_10));
        let rand_xi=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1, cm_h_vec_2, cm_h_vec_3, cm_g, omega/z, y, y_1, y_2, z, 0));
        let rand_xi_2=hash_to_field(to_bytes!(vk.cm_u_vec, vk.cm_w_vec, vk.cm_v_vec, vk.cm_y_vec, cm_u_vec_1, cm_s_vec, cm_h_vec, cm_r_vec_tilde, cm_t_vec_1, cm_h_vec_2, cm_h_vec_3, cm_g, omega/z, y, y_1, y_2, z, 0));
        let zz=z;
        let z=omega/z;
