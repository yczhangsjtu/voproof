    ...
    fn prove(pk: &Self::PK, x: &Self::Ins, w: &Self::Wit) -> Result<Self::Pf, Error> {
        ...
        let h_vec_2 = expression_vector!(
            ...
            linear_combination!(
                ...
                vector_index!(
                    v_vec_1,
                    (-K - 2 * S_a - 2 * S_b - 2 * S_c + i - 1 as i64)
                ...
                vector_index!(
                    v_vec_6,
                    (-K - 2 * S_a - 2 * S_b - 2 * S_c + i - 1 as i64) - (1 - shiftlength_5) as i64
                        + 1
                ),
                ...
                vector_index!(
                    v_vec_16,
                    (-K - 2 * S_a - 2 * S_b - 2 * S_c + i - 1 as i64) - (-3 * H - ell + 1) as i64
                        + 1
                ),
                -power(alpha, 4) * power(omega, 3 * H + ell),
                vector_index!(
                ...
                vector_index!(
                    v_vec_18,
                    (-K - 2 * S_a - 2 * S_b - 2 * S_c + i - 1 as i64) - (1 - shiftlength_8) as i64
                        + 1
                ),
                power(alpha, 5) * omega,
                vector_index!(
                ...
                vector_index!(
                    v_vec_19,
                    (-K - 2 * S_a - 2 * S_b - 2 * S_c + i - 1 as i64) - (-S_a - S_b - S_c) as i64
                        + 1
                ),
                -to_field::<E::Fr>(1),
                vector_index!(
