...
for scale in 1000 2000 4000 8000 16000 32000 64000 128000 256000 512000 1024000; do
  ...
  alias tr1cspe$scale="$prefix test_simple_r1cs_prover_efficient_large_scale_$scale $postfix"
...
alias tr1cspesmall="$prefix test_simple_r1cs_prover_efficient_small_scales $postfix"
